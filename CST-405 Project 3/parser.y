...
%type <ast> Program VarDecl VarDeclList Stmt StmtList Expr FuncDecl FuncCall ParamList ParamDecl MainFunc FuncDeclList Body Array Array_Decl BinOp ExprList
%start Program
