...
void traverseAST(ASTNode* node, int level) {
    ...
    switch (node->type) {
        ...
        case NodeType_WhileStmt:
            ...
            traverseAST(node->whileStatement.expr, level);
            traverseAST(node->whileStatement.body, level + 1);
            break;
...
void freeAST(ASTNode* node) {
    ...
    switch (node->type) {
        ...
        case NodeType_ExprList:
            ...
            break;
        case NodeType_WhileStmt:
            freeAST(node->whileStatement.expr);
            freeAST(node->whileStatement.body);
            break;
        case NodeType_IfStmt:
...
ASTNode* createNode(NodeType type) {
    ...
    switch (type) {
        ...
        case NodeType_ExprList:
            ...
            break;
        case NodeType_WhileStmt:
            newNode->whileStatement.expr = NULL;
            newNode->whileStatement.body = NULL;
            break;
        case NodeType_IfStmt:
